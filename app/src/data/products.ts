...
export const products: Product[] = [
  ...
  {
    id: "pulseras-docentes",
    name: "Pulseras Docentes",
    collection: "Día del Docente",
    type: "pulsera",
    materials: ["cuentas", "dije corazón/estrella/flor"],
    colors: ["dorado", "verde", "rosa", "durazno", "café"],
    description:
      "Cuatro combinaciones pensadas para regalar con cariño. Para esa persona que enseña con el corazón. 🌸",
    price: null,
    available: true,
    customizable: true,
    image: "/products/pulseras-docentes.jpg",
  ...
  {
    id: "pulsera-colombia",
    name: "Pulsera de Colombia",
    collection: "Selección Colombia",
    type: "pulsera",
    materials: ["cuentas marfil", "acentos tricolor"],
    colors: ["marfil", "amarillo", "azul", "rojo"],
    description:
      "Para hinchas de la tricolor. ¡Se agotan rápido cada partido! 🇨🇴",
    price: null,
    available: false,
    customizable: false,
    image: "/products/pulsera-colombia.jpg",
